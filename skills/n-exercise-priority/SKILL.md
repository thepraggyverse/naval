...
description: "Use when applying The Almanack of Naval Ravikant to make daily exercise consistent and priority-driven. Trigger for user requests involving Naval, n-, naval exercise priority, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Make daily exercise consistent and priority-driven.
...
- The user asks for `n-exercise-priority` directly.
- The user asks: "Make exercise non-negotiable."
- The user is dealing with: make daily exercise consistent and priority-driven.
...
User: "Make exercise non-negotiable."
