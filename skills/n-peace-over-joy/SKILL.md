...
description: "Use when applying The Almanack of Naval Ravikant to prefer stable peace over stimulation, bliss chasing, or externally dependent moods. Trigger for user requests involving Naval, n-, naval peace over joy, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Prefer stable peace over stimulation, bliss chasing, or externally dependent moods.
...
- The user asks for `n-peace-over-joy` directly.
- The user asks: "Am I optimizing for peace or excitement?"
- The user is dealing with: prefer stable peace over stimulation, bliss chasing, or externally dependent moods.
- The situation would benefit from a desire audit, acceptance choice, or daily practice.
...
User: "Am I optimizing for peace or excitement?"
