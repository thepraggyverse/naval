...
description: "Use when applying The Almanack of Naval Ravikant to watch thoughts, reactions, fear, desire, and ego as debuggable processes. Trigger for user requests involving Naval, n-, naval mental debugging, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Watch thoughts, reactions, fear, desire, and ego as debuggable processes.
...
- The user asks for `n-mental-debugging` directly.
- The user asks: "Debug my internal monologue."
- The user is dealing with: watch thoughts, reactions, fear, desire, and ego as debuggable processes.
...
User: "Debug my internal monologue."
