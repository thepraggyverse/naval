...
Route vague user situations to the right Naval skill and reference path.
...
- The user asks: "Use Naval to analyze this career decision."
- The user is dealing with: route vague user situations to the right naval skill and reference path.
...
User: "Use Naval to analyze this career decision."
