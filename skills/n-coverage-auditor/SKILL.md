...
description: "Use when applying The Almanack of Naval Ravikant to check whether all book sections are represented by skills and references. Trigger for user requests involving Naval, n-, naval coverage auditor, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Check whether all book sections are represented by skills and references.
...
- The user asks for `n-coverage-auditor` directly.
- The user asks: "Audit whether the Naval plugin missed anything."
- The user is dealing with: check whether all book sections are represented by skills and references.
...
User: "Audit whether the Naval plugin missed anything."
