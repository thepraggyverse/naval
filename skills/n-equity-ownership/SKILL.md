...
description: "Use when applying The Almanack of Naval Ravikant to move from wage or service work toward ownership, ip, assets, and upside. Trigger for user requests involving Naval, n-, naval equity ownership, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Move from wage or service work toward ownership, IP, assets, and upside.
...
- The user asks for `n-equity-ownership` directly.
- The user asks: "How do I get equity or upside here?"
- The user is dealing with: move from wage or service work toward ownership, ip, assets, and upside.
...
User: "How do I get equity or upside here?"
