...
description: "Use when applying The Almanack of Naval Ravikant to treat anger as self-punishment and find a cleaner response. Trigger for user requests involving Naval, n-, naval anger release, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Treat anger as self-punishment and find a cleaner response.
...
- The user asks for `n-anger-release` directly.
- The user asks: "Help me process this anger."
- The user is dealing with: treat anger as self-punishment and find a cleaner response.
...
User: "Help me process this anger."
