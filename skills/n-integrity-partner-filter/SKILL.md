...
Assess collaborators for integrity, optimism, energy, and long-term fit.
...
- The user asks for `n-integrity-partner-filter` directly.
- The user asks: "Should I work with this person?"
- The user is dealing with: assess collaborators for integrity, optimism, energy, and long-term fit.
...
User: "Should I work with this person?"
