...
description: "Use when applying The Almanack of Naval Ravikant to simplify diet by subtracting processed food and appetite traps. Trigger for user requests involving Naval, n-, naval diet simplifier, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Simplify diet by subtracting processed food and appetite traps.
...
- The user asks for `n-diet-simplifier` directly.
- The user asks: "Simplify my diet Naval-style."
- The user is dealing with: simplify diet by subtracting processed food and appetite traps.
...
User: "Simplify my diet Naval-style."
