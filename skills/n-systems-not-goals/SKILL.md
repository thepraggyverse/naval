...
description: "Use when applying The Almanack of Naval Ravikant to turn goals into environments and systems that make success likely. Trigger for user requests involving Naval, n-, naval systems not goals, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
- The user asks for `n-systems-not-goals` directly.
- The user asks: "Turn this goal into a system."
- The user is dealing with: turn goals into environments and systems that make success likely.
