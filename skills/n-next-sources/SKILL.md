...
Point users to deeper Naval resources, podcasts, essays, and source trails.
...
- The user asks for `n-next-sources` directly.
- The user asks: "Where should I go deeper on this topic?"
- The user is dealing with: point users to deeper naval resources, podcasts, essays, and source trails.
...
User: "Where should I go deeper on this topic?"
