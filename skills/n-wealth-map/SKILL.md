---
name: n-wealth-map
description: "Use when applying The Almanack of Naval Ravikant to create an end-to-end wealth strategy using specific knowledge, accountability, ownership, leverage, and patience. Trigger for user requests involving Naval, n-, naval wealth map, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
