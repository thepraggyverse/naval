---
name: n-wealth-map
description: "Apply The Almanack of Naval Ravikant to create an end-to-end wealth strategy using specific knowledge, accountability, ownership, leverage, and patience. Use when the user asks for n-wealth-map, says \"Build me a Naval-style wealth plan.\", or wants this Naval lens."
---
...
Create an end-to-end wealth strategy using specific knowledge, accountability, ownership, leverage, and patience.
...
- The user asks for `n-wealth-map` directly.
- The user asks: "Build me a Naval-style wealth plan."
- The user is dealing with: create an end-to-end wealth strategy using specific knowledge, accountability, ownership, leverage, and patience.
...
User: "Build me a Naval-style wealth plan."
