...
description: "Naval values filter: Apply values: honesty, long-term thinking, peer relationships, low anger, and freedom. Trigger when the user asks \"What values are being violated here?\" or names n-values-filter."
---
