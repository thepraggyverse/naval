---
name: n-values-filter
description: "Use when applying The Almanack of Naval Ravikant to apply values: honesty, long-term thinking, peer relationships, low anger, and freedom. Trigger for user requests involving Naval, n-, naval values filter, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Apply values: honesty, long-term thinking, peer relationships, low anger, and freedom.
...
- The user asks for `n-values-filter` directly.
- The user asks: "What values are being violated here?"
- The user is dealing with: apply values: honesty, long-term thinking, peer relationships, low anger, and freedom.
- The situation would benefit from a values clarification, boundary, or immediate action.
...
User: "What values are being violated here?"
