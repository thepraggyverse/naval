...
description: "Apply The Almanack of Naval Ravikant to apply values: honesty, long-term thinking, peer relationships, low anger, and freedom. Use when the user asks for n-values-filter, says \"What values are being violated here?\", or wants this Naval lens."
---
