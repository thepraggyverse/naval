...
description: "Use when applying The Almanack of Naval Ravikant to use mortality to clarify priorities and reduce ego battles. Trigger for user requests involving Naval, n-, naval death awareness, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Use mortality to clarify priorities and reduce ego battles.
...
- The user asks for `n-death-awareness` directly.
- The user asks: "Use mortality to clarify this decision."
- The user is dealing with: use mortality to clarify priorities and reduce ego battles.
...
User: "Use mortality to clarify this decision."
