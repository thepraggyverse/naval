...
Use compounding, incentives, evolution, game theory, complexity, inversion, and probability.
...
- The user asks: "Which mental models apply here?"
- The user is dealing with: use compounding, incentives, evolution, game theory, complexity, inversion, and probability.
...
User: "Which mental models apply here?"
