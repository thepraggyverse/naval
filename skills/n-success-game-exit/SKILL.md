...
Notice when the user has outgrown a game with big rewards.
...
- The user asks: "Have I outgrown this game?"
- The user is dealing with: notice when the user has outgrown a game with big rewards.
...
User: "Have I outgrown this game?"
