...
description: "Use when applying The Almanack of Naval Ravikant to build book paths across science, mental models, philosophy, economics, and fiction. Trigger for user requests involving Naval, n-, naval reading curriculum, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Build book paths across science, mental models, philosophy, economics, and fiction.
...
- `../../references/workflows/reading-curriculum.md`

## Use When

- The user asks for `n-reading-curriculum` directly.
- The user asks: "Build me a Naval reading curriculum."
- The user is dealing with: build book paths across science, mental models, philosophy, economics, and fiction.
- The situation would benefit from a short reading path or learning system.
...
User: "Build me a Naval reading curriculum."
