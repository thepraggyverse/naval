---
name: n-flashcards
description: "Use when applying The Almanack of Naval Ravikant to turn principles into recall prompts, reflection cards, or spaced repetition items. Trigger for user requests involving Naval, n-, naval flashcards, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Turn principles into recall prompts, reflection cards, or spaced repetition items.
...
- The user asks for `n-flashcards` directly.
- The user asks: "Make flashcards from this Naval topic."
- The user is dealing with: turn principles into recall prompts, reflection cards, or spaced repetition items.
...
User: "Make flashcards from this Naval topic."
