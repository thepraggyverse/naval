---
name: n-judgment-builder
description: "Use when applying The Almanack of Naval Ravikant to improve decision quality in leveraged work and life choices. Trigger for user requests involving Naval, n-, naval judgment builder, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---

# Naval Judgment Builder

## Purpose

Improve decision quality in leveraged work and life choices.
...
- The user asks for `n-judgment-builder` directly.
- The user asks: "Improve my judgment on this bet."
- The user is dealing with: improve decision quality in leveraged work and life choices.
...
User: "Improve my judgment on this bet."
