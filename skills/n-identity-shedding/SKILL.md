---
name: n-identity-shedding
description: "Use when applying The Almanack of Naval Ravikant to drop inherited labels, tribes, packages, and stale self-images. Trigger for user requests involving Naval, n-, naval identity shedding, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---

# Naval Identity Shedding

## Purpose

Drop inherited labels, tribes, packages, and stale self-images.
...
- The user asks for `n-identity-shedding` directly.
- The user asks: "What identity is trapping my thinking?"
- The user is dealing with: drop inherited labels, tribes, packages, and stale self-images.
- The situation would benefit from a decision recommendation or falsifiable test.
...
User: "What identity is trapping my thinking?"
