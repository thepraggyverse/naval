...
description: "Use when applying The Almanack of Naval Ravikant to train happiness as a baseline using peace, habits, presence, and acceptance. Trigger for user requests involving Naval, n-, naval happiness baseline, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Train happiness as a baseline using peace, habits, presence, and acceptance.
...
- The user asks for `n-happiness-baseline` directly.
- The user asks: "Help me raise my happiness baseline."
- The user is dealing with: train happiness as a baseline using peace, habits, presence, and acceptance.
...
User: "Help me raise my happiness baseline."
