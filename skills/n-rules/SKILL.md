...
Apply compact Naval rules and maxims as reminders, not substitutes for reasoning.
...
- The user asks for `n-rules` directly.
- The user asks: "Give me the relevant Naval rule."
- The user is dealing with: apply compact naval rules and maxims as reminders, not substitutes for reasoning.
...
User: "Give me the relevant Naval rule."
