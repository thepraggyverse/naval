...
description: "Use when applying The Almanack of Naval Ravikant to score jobs, startups, projects, products, content, and investments. Trigger for user requests involving Naval, n-, naval opportunity scorecard, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Score jobs, startups, projects, products, content, and investments.
...
- The user asks for `n-opportunity-scorecard` directly.
- The user asks: "Score this opportunity Naval-style."
- The user is dealing with: score jobs, startups, projects, products, content, and investments.
...
User: "Score this opportunity Naval-style."
