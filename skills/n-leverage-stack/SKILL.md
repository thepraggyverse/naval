---
name: n-leverage-stack
description: "Use when applying The Almanack of Naval Ravikant to find code, media, capital, labor, brand, distribution, and automation leverage. Trigger for user requests involving Naval, n-, naval leverage stack, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---

# Naval Leverage Stack

## Purpose

Find code, media, capital, labor, brand, distribution, and automation leverage.
...
- The user asks for `n-leverage-stack` directly.
- The user asks: "What leverage can I add to this project?"
- The user is dealing with: find code, media, capital, labor, brand, distribution, and automation leverage.
- The situation would benefit from a scorecard or 7-day wealth experiment.
...
User: "What leverage can I add to this project?"
