...
description: "Naval source fidelity. Trigger on \"Check this Naval idea before I cite it.\" or n-source-fidelity."
---
...
Keep interpretations faithful to the book, avoid over-quoting, and flag when exact phrasing needs verification.
...
- The user asks: "Check this Naval idea before I cite it."
- The user is dealing with: keep interpretations faithful to the book, avoid over-quoting, and flag when exact phrasing needs verification.
...
User: "Check this Naval idea before I cite it."
