---
name: n-build-or-sell
description: "Use when applying The Almanack of Naval Ravikant to choose whether to learn building, selling, or both for a tech or business path. Trigger for user requests involving Naval, n-, naval build or sell, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Choose whether to learn building, selling, or both for a tech or business path.
...
- The user asks for `n-build-or-sell` directly.
- The user asks: "Should I learn to build, sell, or both?"
- The user is dealing with: choose whether to learn building, selling, or both for a tech or business path.
...
User: "Should I learn to build, sell, or both?"
