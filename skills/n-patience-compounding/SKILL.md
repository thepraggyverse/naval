...
description: "Use when applying The Almanack of Naval Ravikant to balance impatience with action against patience for compounding results. Trigger for user requests involving Naval, n-, naval patience compounding, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Balance impatience with action against patience for compounding results.
...
- The user asks for `n-patience-compounding` directly.
- The user asks: "Where do I need patience versus action?"
- The user is dealing with: balance impatience with action against patience for compounding results.
...
User: "Where do I need patience versus action?"
