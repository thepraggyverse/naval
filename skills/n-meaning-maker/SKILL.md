...
description: "Use when applying The Almanack of Naval Ravikant to explore personal meaning without pretending there is a universal borrowed answer. Trigger for user requests involving Naval, n-, naval meaning maker, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Explore personal meaning without pretending there is a universal borrowed answer.
...
- The user asks for `n-meaning-maker` directly.
- The user asks: "Help me find my current meaning."
- The user is dealing with: explore personal meaning without pretending there is a universal borrowed answer.
...
User: "Help me find my current meaning."
