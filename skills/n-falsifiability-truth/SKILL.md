...
description: "Use when applying The Almanack of Naval Ravikant to test whether claims have predictive power and can be falsified. Trigger for user requests involving Naval, n-, naval falsifiability truth, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Test whether claims have predictive power and can be falsified.
...
- The user asks for `n-falsifiability-truth` directly.
- The user asks: "Is this claim actually testable?"
- The user is dealing with: test whether claims have predictive power and can be falsified.
...
User: "Is this claim actually testable?"
