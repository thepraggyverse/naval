...
Turn the mind from master into tool by reducing compulsive inner narration.
...
- The user asks for `n-uncontrolled-thinking` directly.
- The user asks: "Help me stop compulsive thinking."
- The user is dealing with: turn the mind from master into tool by reducing compulsive inner narration.
...
User: "Help me stop compulsive thinking."
