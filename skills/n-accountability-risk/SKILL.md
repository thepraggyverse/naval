...
description: "Naval accountability risk: Decide when to put reputation, name, capital, and responsibility behind an action. Trigger when the user asks \"Should I take public accountability for this?\" or names n-accountability-risk."
---
...
Decide when to put reputation, name, capital, and responsibility behind an action.
...
- The user asks: "Should I take public accountability for this?"
- The user is dealing with: decide when to put reputation, name, capital, and responsibility behind an action.
...
User: "Should I take public accountability for this?"
