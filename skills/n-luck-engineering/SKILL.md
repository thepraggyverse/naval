...
description: "Use when applying The Almanack of Naval Ravikant to create conditions for luck through motion, skill, reputation, and unique character. Trigger for user requests involving Naval, n-, naval luck engineering, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Create conditions for luck through motion, skill, reputation, and unique character.
...
- The user asks for `n-luck-engineering` directly.
- The user asks: "How do I make luck find me?"
- The user is dealing with: create conditions for luck through motion, skill, reputation, and unique character.
...
User: "How do I make luck find me?"
