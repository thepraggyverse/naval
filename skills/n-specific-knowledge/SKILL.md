...
description: "Use when applying The Almanack of Naval Ravikant to identify hard-to-train strengths, obsessions, taste, and authentic edges. Trigger for user requests involving Naval, n-, naval specific knowledge, life design, wealth, judgment, happiness, health, values, or book-derived operating principles."
---
...
Identify hard-to-train strengths, obsessions, taste, and authentic edges.
...
- The user asks for `n-specific-knowledge` directly.
- The user asks: "Help me identify my specific knowledge."
- The user is dealing with: identify hard-to-train strengths, obsessions, taste, and authentic edges.
...
User: "Help me identify my specific knowledge."
